...
@Component({
  selector: 'app-view-expense-report-validation',
  templateUrl: './view-expense-report-validation.component.html',
  styleUrls: ['./view-expense-report-validation.component.scss']
})
export class ViewExpenseReportValidationComponent implements OnInit {
  id: number;
  ...
  constructor( 
    ...
    getExpenseReportById(): void {
      this.expenseReportValidationService.getItem(this.id).subscribe((dataView: any) => {
